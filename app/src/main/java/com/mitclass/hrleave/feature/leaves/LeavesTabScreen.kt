...
fun LeavesTabScreen(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        when (selectedTab) {
            0 -> LeaveRequestsListScreen(onItemClick = onRequestItemClick, onCreateClick = onRequestCreateClick)
            else -> LeavePlanRequestsListScreen(onItemClick = onPlanItemClick, onCreateClick = onPlanCreateClick)
        }
    }
}
